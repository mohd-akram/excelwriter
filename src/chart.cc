...
Napi::Object Chart::Init(Napi::Env env, Napi::Object exports) {
  auto func = DefineClass(
      env,
      "Chart",
      {InstanceMethod<&Chart::AddSeries>(
           "addSeries",
           static_cast<napi_property_attributes>(napi_writable |
                                                 napi_configurable)),
       InstanceMethod<&Chart::SetTitleName>(
           "setTitleName",
           static_cast<napi_property_attributes>(napi_writable |
                                                 napi_configurable)),
       InstanceMethod<&Chart::SetTitleNameFont>(
           "setTitleNameFont",
           static_cast<napi_property_attributes>(napi_writable |
                                                 napi_configurable)),
       StaticValue(
           "AREA_CHART", Napi::Number::New(env, LXW_CHART_AREA), napi_default),
       ...
       StaticValue("AREA_STACKED_PERCENT_CHART",
                   ...
                   napi_default),
       StaticValue(
           "BAR_CHART", Napi::Number::New(env, LXW_CHART_BAR), napi_default),
       ...
       StaticValue("DOUGHNUT_CHART",
                   ...
                   napi_default),
       StaticValue(
           "LINE_CHART", Napi::Number::New(env, LXW_CHART_LINE), napi_default),
       ...
       StaticValue("LINE_STACKED_PERCENT_CHART",
                   ...
                   napi_default),
       StaticValue(
           "PIE_CHART", Napi::Number::New(env, LXW_CHART_PIE), napi_default),
